...
to keep the logging output within a certain character threshold. This is
identical behaviour to the original Testarossa circular output throttle that
existed before Loggers.
...
with truncation occurring as necessary. The memory buffer is not
null-terminated.
