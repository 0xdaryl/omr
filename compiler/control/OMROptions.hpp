...
public:
    ...
    /**
     * @brief
     *    Returns the default TR::Logger object.  If this function is not overridden
     *    by a consuming project, the default logger is a TR::NullLogger.
     */
    static TR::Logger *getDefaultLogger();
    ...
    /**
     * @brief Creates a \c TR::Logger object for this compilation that wraps
     *    around the log file.  The default logger is a \c TR::CStdIOStreamLogger.
     *
     * @details
     *    This function may be specialized by downstream projects to provide their
     *    own choice of \c TR::Logger.
     *
     * @param[in] file : A \c TR::FILE handle to the log file
     *
     * @return : a \c TR::Logger object
     */
