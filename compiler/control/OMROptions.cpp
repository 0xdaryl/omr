...
TR::OptionTable OMR::Options::_jitOptions[] = {
    ...
    { "disclaimMemoryOnSwap",
     "M\tuse swap file as a backup for disclaimed memory (linux only). Can be enabled internally by the JVM", SET_OPTION_BIT(TR_DisclaimMemoryOnSwap), "F", NOT_IN_SUBSET },
