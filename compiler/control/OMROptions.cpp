...
TR::OptionTable OMR::Options::_jitOptions[] = {
    ...
    { "forceCStdIOForLogFile", "M\tforce the use of C Stdio for JIT log file", SET_OPTION_BIT(TR_ForceCStdIOForLogFile), "F" },
    ...
    { "forceTRIOForLogFile", "M\tforce the use of TR IO for JIT log file", SET_OPTION_BIT(TR_ForceTRIOForLogFile), "F" },
...
OMR::Logger *OMR::Options::createLoggerForLogFile(TR::FILE *file)
{
    ...
    if (self()->getOption(TR_ForceTRIOForLogFile)) {
