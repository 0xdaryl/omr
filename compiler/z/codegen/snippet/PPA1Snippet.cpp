...
uint8_t*
TR::PPA1Snippet::emitSnippetBody()
   {
...
uint32_t
TR::PPA1Snippet::getLength(int32_t estimatedSnippetStart)
   {
   return FIXED_AREA_SIZE;
   }
...
void
TR::PPA1Snippet::PPA1OffsetToPPA2Relocation::apply(TR::CodeGenerator* cg)
   {
