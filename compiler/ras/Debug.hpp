...
public:
    ...
    virtual void print(OMR::Logger *log, TR::SymbolReference *, bool hideHelperMethodInfo = false, bool verbose = false);
    ...
    void printSymRefOffset(OMR::Logger *log, TR::SymbolReference *symRef);
    void printSymRefObjIndex(OMR::Logger *log, TR::SymbolReference *symRef);
    void printSymRefKind(OMR::Logger *log, TR::SymbolReference *symRef);
    void printSymRefName(OMR::Logger *log, TR::SymbolReference *symRef);
    void printSymRefOtherInfo(OMR::Logger *log, TR::SymbolReference *symRef);
