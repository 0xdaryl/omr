...
public:
    ...
    *        memory for the string if required.
    *
    * @param[in] structure : \c TR_Structure object
    */
   virtual const char * getName(TR_Structure *structure);
   ...
   /**
    * @brief Print a \c TR_RegionStructure to a given output stream
    *
    * @param[in] pOutFile : output stream
    * @param[in] regionStructure : \c TR_RegionStructure object to print
    * @param[in] indentation : number of spaces to indent
    * @param[in] memRegion : \c TR::Region to satisfy any memory requests
    */
...
// ------------------------------
   ...
   /**
    * @brief Return null-terminated char string name for given \c TR::SymbolReference object
    *        representing a \c TR::ParameterSymbol.
    *
    * @param[in] symRef : \c TR::SymbolReference object
    * @param[in] memRegion : \c TR::Region to allocate memory for the string if required
    */
    ...
    *
    * @param[in] pOutFile : output stream
    * @param[in] node : \c TR_StructureSubGraphNode object to print
    * @param[in] indentation : number of spaces to indent
    * @param[in] memRegion : \c TR::Region to satisfy any memory requests
    */
   void print(TR::FILE *pOutFile, TR_StructureSubGraphNode *node, uint32_t indentation, TR::Region &memRegion);
