...
public:
     ...
     */
    static CircularLogger *create(TR::Logger *innerLogger, int64_t rewindThresholdInChars);
     ...
     */
    TR::Logger *getInnerLogger() { return _innerLogger; }

    void setInnerLogger(TR::Logger *il) { _innerLogger = il; }
...
private:
    CircularLogger(TR::Logger *innerLogger, int64_t rewindThresholdInChars);
 ...
 * overflows.
 *
 * All content logged is terminated with a null-termination character.
 *
...
public:
     ...
     *     that the size of the buffer must include space for one null-termination
     *     character.
     *
     ...
     *     there been suffient space is returned.
     *
     * @return
