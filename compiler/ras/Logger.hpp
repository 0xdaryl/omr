...
public:
     ...
     * @return A \c CStdIOStreamLogger object if successful; NULL on any error
     */
    template<typename AllocatorType> static CStdIOStreamLogger *create(AllocatorType t, const char *filename, const char *fileMode = "wb+");
...
template OMR::CStdIOStreamLogger *OMR::CStdIOStreamLogger::create(TR_HeapMemory t, const char *filename, const char *fileMode);

template OMR::CStdIOStreamLogger *OMR::CStdIOStreamLogger::create(PERSISTENT_NEW_DECLARE t, const char *filename, const char *fileMode);
...
public:
     ...
     * @return A \c TRIOStreamLogger object if successful; NULL on any error
     */
    template<typename AllocatorType> static TRIOStreamLogger *create(AllocatorType t, const char *filename, const char *fileMode = "wb+");
...
template OMR::TRIOStreamLogger *OMR::TRIOStreamLogger::create(TR_HeapMemory t, const char *filename, const char *fileMode);

template OMR::TRIOStreamLogger *OMR::TRIOStreamLogger::create(PERSISTENT_NEW_DECLARE t, const char *filename, const char *fileMode);
