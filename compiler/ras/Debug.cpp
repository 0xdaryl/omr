   ...
   if (index < TR_FSRH)
      ...
      if (index < TR_LXRH)
         ...
         switch(index)
            ...
            case TR_AMD64resolveVirtualDispatch:                      return "resolveVirtualDispatch";
            case TR_AMD64populateMethodInIPICDataSlot:                return "populateMethodInIPICDataSlot";
            case TR_AMD64dispatchInterpretedFromIPICDataSlot:         return "dispatchInterpretedFromIPICDataSlot";
            case TR_AMD64IPICResolveNoPatching:                       return "IPICResolveNoPatching";
            case TR_AMD64IPicLookupDispatchNoPatching:                return "IPicLookupDispatchNoPatching";
