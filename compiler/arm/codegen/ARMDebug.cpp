...
void
TR_Debug::print(TR::Logger *log, TR::ARMLabelInstruction * instr)
   {
   printPrefix(log, instr);
...
#ifdef J9_PROJECT_SPECIFIC
void
TR_Debug::print(TR::Logger *log, TR::ARMVirtualGuardNOPInstruction * instr)
   {
   printPrefix(log, instr);
...
void
TR_Debug::print(TR::Logger *log, TR::ARMAdminInstruction * instr)
   {
...
void
TR_Debug::print(TR::Logger *log, TR::ARMImmInstruction * instr)
   {
   printPrefix(log, instr);
...
void
TR_Debug::print(TR::Logger *log, TR::ARMImmSymInstruction * instr)
   {
...
void
TR_Debug::print(TR::Logger *log, TR::ARMTrg1Src2Instruction * instr)
   {
#if (defined(__VFP_FP__) && !defined(__SOFTFP__))
   ...
   if (instr->getOpCodeValue() == TR::InstOpCode::fmrs)
      ...
      {
      print(log, instr->getTarget1Register(), (instr->getOpCodeValue() == TR::InstOpCode::fcmpzd) ? TR_DoubleReg : TR_WordReg);
#if defined(__ARM_ARCH_7A__) && defined(__VFP_FP__) && !defined(__SOFTFP__)
      log->prints(", #0.0");
#endif
      }
...
#if (defined(__VFP_FP__) && !defined(__SOFTFP__))
void
TR_Debug::print(TR::Logger *log, TR::ARMTrg2Src1Instruction * instr)
   {
   // fmrrd
...
void
TR_Debug::print(TR::Logger *log, TR::ARMMulInstruction * instr)
   {
   printPrefix(log, instr);
   log->printf("%s\t", fullOpCodeName(instr));
...
void
TR_Debug::print(TR::Logger *log, TR::ARMMemSrc1Instruction * instr)
   {
   if(instr->getBinaryEncoding() &&
...
void
TR_Debug::print(TR::Logger *log, TR::ARMTrg1Instruction * instr)
   {
   printPrefix(log, instr);
   log->printf("%s\t", fullOpCodeName(instr));
...
void
TR_Debug::print(TR::Logger *log, TR::ARMMemInstruction * instr)
   {
   printPrefix(log, instr);
   log->printf("%s\t", fullOpCodeName(instr));
   print(log, instr->getMemoryReference());
...
void
TR_Debug::print(TR::Logger *log, TR::ARMTrg1MemInstruction * instr)
   {
   if(instr->getBinaryEncoding() &&
      instr->getMemoryReference()->hasDelayedOffset() &&
      !instr->getMemoryReference()->getUnresolvedSnippet())
...
void
TR_Debug::print(TR::Logger *log, TR::ARMTrg1MemSrc1Instruction * instr)
   {
   // strex
   printPrefix(log, instr);
   log->printf("%s\t", fullOpCodeName(instr));
...
void
TR_Debug::print(TR::Logger *log, TR::ARMControlFlowInstruction * instr)
   {
   printPrefix(log, instr);
   log->printf("%s\t", fullOpCodeName(instr));
...
void
TR_Debug::print(TR::Logger *log, TR::ARMMultipleMoveInstruction * instr)
   {
   printPrefix(log, instr);
   log->printf("%s\t", fullOpCodeName(instr));
...
void
TR_Debug::print(TR::Logger *log, TR_ARMOperand2 * op, TR_RegisterSizes size)
   {
   switch (op->_opType)
      {
      case ARMOp2RegLSLImmed:  print(log, op->_baseRegister, size); log->printf(" LSL #%d", op->_shiftOrImmed); break;
      case ARMOp2RegLSRImmed:  print(log, op->_baseRegister, size); log->printf(" LSR #%d", op->_shiftOrImmed); break;
      case ARMOp2RegASRImmed:  print(log, op->_baseRegister, size); log->printf(" ASR #%d", op->_shiftOrImmed); break;
      case ARMOp2RegRORImmed:  print(log, op->_baseRegister, size); log->printf(" ROR #%d", op->_shiftOrImmed); break;
      case ARMOp2Reg:          print(log, op->_baseRegister, size); break;
      case ARMOp2RegRRX:       print(log, op->_baseRegister, size); log->prints(" RRX"); break;
      case ARMOp2RegLSLReg:    print(log, op->_baseRegister, size); log->prints(" LSL "); print(log, op->_shiftRegister, size); break;
      case ARMOp2RegLSRReg:    print(log, op->_baseRegister, size); log->prints(" LSR "); print(log, op->_shiftRegister, size); break;
      case ARMOp2RegASRReg:    print(log, op->_baseRegister, size); log->prints(" ASR "); print(log, op->_shiftRegister, size); break;
      case ARMOp2RegRORReg:    print(log, op->_baseRegister, size); log->prints(" ROR "); print(log, op->_shiftRegister, size); break;
      case ARMOp2Immed8r:
         if (op->_immedShift)
            log->printf("#0x%08x (0x%x << %d)", op->_shiftOrImmed << op->_immedShift, op->_shiftOrImmed, op->_immedShift);
         else
...
void
TR_Debug::printARMGCRegisterMap(TR::Logger *log, TR::GCRegisterMap * map)
   {
   TR::Machine *machine = _cg->machine();
...
void
TR_Debug::printa(TR::Logger *log, TR::Snippet * snippet)
   {
   switch (snippet->getKind())
      {
      case TR::Snippet::IsCall:
...
void
TR_Debug::print(TR::Logger *log, TR::ARMCallSnippet * snippet)
   {
         ...
         case TR::Int64:
            ...
            if (numIntArgs < linkageProperties.getNumIntArgRegs())
               ...
               if (numIntArgs < linkageProperties.getNumIntArgRegs() - 1)
                  ...
                  print(log, machine->getRealRegister(linkageProperties.getIntegerArgumentRegister(numIntArgs + 1)));
                  bufferPos += 4;
                  }
               }
            numIntArgs += 2;
...
void
TR_Debug::print(TR::Logger *log, TR::ARMUnresolvedCallSnippet * snippet)
   {
#ifdef J9_PROJECT_SPECIFIC
...
void
TR_Debug::print(TR::Logger *log, TR::ARMVirtualUnresolvedSnippet * snippet)
   {
#ifdef J9_PROJECT_SPECIFIC
...
void
TR_Debug::print(TR::Logger *log, TR::ARMInterfaceCallSnippet * snippet)
   {
#ifdef J9_PROJECT_SPECIFIC
   TR::SymbolReference *callSymRef = snippet->getNode()->getSymbolReference();
...
void
TR_Debug::print(TR::Logger *log, TR::ARMHelperCallSnippet * snippet)
   {
#ifdef J9_PROJECT_SPECIFIC
   uint8_t *bufferPos = snippet->getSnippetLabel()->getCodeLocation();
   ...
   if (restartLabel)
      ...
      log->printf("b \t" POINTER_PRINTF_FORMAT "\t\t; Return to %s", (intptr_t)(restartLabel->getCodeLocation()), getName(restartLabel));
      }
#endif
   }

void
TR_Debug::print(TR::Logger *log, TR::ARMStackCheckFailureSnippet * snippet)
   {
   uint8_t *bufferPos  = snippet->getSnippetLabel()->getCodeLocation();
   printSnippetLabel(log, snippet->getSnippetLabel(), bufferPos, getName(snippet));
...
void
TR_Debug::print(TR::Logger *log, TR::ARMRecompilationSnippet * snippet)
   {
#ifdef J9_PROJECT_SPECIFIC
...
void
TR_Debug::printARMDelayedOffsetInstructions(TR::Logger *log, TR::ARMMemInstruction *instr)
   {
   bool regSpilled;
   uint8_t *bufferPos   = instr->getBinaryEncoding();
   int32_t offset       = instr->getMemoryReference()->getOffset();
