...
public:
   ...
   FunctionCallData(
      ...
      methodSymRef(parm_methodSymRef),
   ...
   /**
    * The address of a buffer where the function call is to be emitted,
    * or 0 if the buffer address is unknown or not required.
    */
   uint8_t *bufferAddress;

   /**
    * If the address of the funtion is known and it is encoded somewhere
    * as part of the function dispatch sequence then this field records
