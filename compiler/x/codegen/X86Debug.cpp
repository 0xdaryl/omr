...
void TR_Debug::printx(TR::Logger *log, TR::Instruction *instr)
{
...
void TR_Debug::printPrefix(TR::Logger *log, TR::Instruction *instr)
{
    printPrefix(log, instr, instr->getBinaryEncoding(), instr->getBinaryLength());
}

void TR_Debug::printDependencyConditions(TR::Logger *log, TR::RegisterDependencyGroup *conditions,
...
void TR_Debug::printFullRegisterDependencyInfo(TR::Logger *log, TR::RegisterDependencyConditions *conditions)
{
...
void TR_Debug::dumpDependencyGroup(TR::Logger *log, TR::RegisterDependencyGroup *group, int32_t numConditions,
...
void TR_Debug::dumpDependencies(TR::Logger *log, TR::Instruction *instr)
{
...
void TR_Debug::printRegisterInfoHeader(TR::Logger *log, TR::Instruction *instr)
{
...
void TR_Debug::printReferencedRegisterInfo(TR::Logger *log, TR::Instruction *instr)
{
...
void TR_Debug::print(TR::Logger *log, TR::X86PaddingInstruction *instr)
{
    printPrefix(log, instr);
...
void TR_Debug::print(TR::Logger *log, TR::X86AlignmentInstruction *instr)
{
...
void TR_Debug::printBoundaryAvoidanceInfo(TR::Logger *log, TR::X86BoundaryAvoidanceInstruction *instr)
{
...
void TR_Debug::print(TR::Logger *log, TR::X86BoundaryAvoidanceInstruction *instr)
{
    printPrefix(log, instr);
    if (instr->getBinaryEncoding())
        log->printf("nop (%d byte%s)\t\t%s ", instr->getBinaryLength(), (instr->getBinaryLength() == 1) ? "" : "s",
...
void TR_Debug::print(TR::Logger *log, TR::X86PatchableCodeAlignmentInstruction *instr)
{
    printPrefix(log, instr);
    if (instr->getBinaryEncoding())
        log->printf("nop (%d byte%s)\t\t%s ", instr->getBinaryLength(), (instr->getBinaryLength() == 1) ? "" : "s",
...
void TR_Debug::print(TR::Logger *log, TR::X86LabelInstruction *instr)
{
    printPrefix(log, instr);
...
void TR_Debug::print(TR::Logger *log, TR::X86FenceInstruction *instr)
{
...
#ifdef J9_PROJECT_SPECIFIC
void TR_Debug::print(TR::Logger *log, TR::X86VirtualGuardNOPInstruction *instr)
{
    printPrefix(log, instr);
...
void TR_Debug::print(TR::Logger *log, TR::X86ImmInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s\t", getMnemonicName(&instr->getOpCode()));
...
void TR_Debug::print(TR::Logger *log, TR::AMD64Imm64Instruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s\t", getMnemonicName(&instr->getOpCode()));
...
void TR_Debug::print(TR::Logger *log, TR::AMD64Imm64SymInstruction *instr)
{
    printPrefix(log, instr);
...
void TR_Debug::print(TR::Logger *log, TR::AMD64RegImm64Instruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s\t", getMnemonicName(&instr->getOpCode()));
...
void TR_Debug::print(TR::Logger *log, TR::X86ImmSnippetInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s\t", getMnemonicName(&instr->getOpCode()));
    printIntConstant(log, instr->getSourceImmediate(), 16, getImmediateSizeFromInstruction(instr), true);
...
void TR_Debug::print(TR::Logger *log, TR::X86ImmSymInstruction *instr)
{
    TR::Symbol *sym = instr->getSymbolReference()->getSymbol();
    const char *name = getName(instr->getSymbolReference());
...
void TR_Debug::print(TR::Logger *log, TR::X86RegInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s\t", getMnemonicName(&instr->getOpCode()));
    if (!(instr->getOpCode().targetRegIsImplicit() != 0))
...
void TR_Debug::printReferencedRegisterInfo(TR::Logger *log, TR::X86RegInstruction *instr)
{
    printRegisterInfoHeader(log, instr);
    log->prints("    Target            ");
...
void TR_Debug::print(TR::Logger *log, TR::X86RegRegInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s\t", getMnemonicName(&instr->getOpCode()));
    if (!(instr->getOpCode().targetRegIsImplicit() != 0))
...
void TR_Debug::print(TR::Logger *log, TR::X86RegMaskRegInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s\t", getMnemonicName(&instr->getOpCode()));
...
void TR_Debug::printReferencedRegisterInfo(TR::Logger *log, TR::X86RegRegInstruction *instr)
{
    printRegisterInfoHeader(log, instr);
    log->prints("    Target            ");
    printFullRegInfo(log, instr->getTargetRegister());
...
void TR_Debug::print(TR::Logger *log, TR::X86RegImmInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s\t", getMnemonicName(&instr->getOpCode()));
    if (!(instr->getOpCode().targetRegIsImplicit() != 0)) {
...
void TR_Debug::print(TR::Logger *log, TR::X86RegRegImmInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s\t", getMnemonicName(&instr->getOpCode()));
    if (!(instr->getOpCode().targetRegIsImplicit() != 0)) {
...
void TR_Debug::print(TR::Logger *log, TR::X86RegMaskRegRegInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s\t", getMnemonicName(&instr->getOpCode()));
...
void TR_Debug::print(TR::Logger *log, TR::X86RegMaskRegRegImmInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s\t", getMnemonicName(&instr->getOpCode()));
...
void TR_Debug::print(TR::Logger *log, TR::X86RegRegRegInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s\t", getMnemonicName(&instr->getOpCode()));
    if (!(instr->getOpCode().targetRegIsImplicit() != 0)) {
...
void TR_Debug::printReferencedRegisterInfo(TR::Logger *log, TR::X86RegRegRegInstruction *instr)
{
    printRegisterInfoHeader(log, instr);
    log->prints("    Source            ");
    printFullRegInfo(log, instr->getSourceRegister());
...
int32_t TR_Debug::printPrefixAndMnemonicWithoutBarrier(TR::Logger *log, TR::Instruction *instr, int32_t barrier)
{
...
void TR_Debug::printPrefixAndMemoryBarrier(TR::Logger *log, TR::Instruction *instr, int32_t barrier,
...
void TR_Debug::print(TR::Logger *log, TR::X86MemInstruction *instr)
{
...
void TR_Debug::printReferencedRegisterInfo(TR::Logger *log, TR::X86MemInstruction *instr)
{
    printRegisterInfoHeader(log, instr);
...
void TR_Debug::print(TR::Logger *log, TR::X86MemImmInstruction *instr)
{
    int32_t barrier = memoryBarrierRequired(instr->getOpCode(), instr->getMemoryReference(), _cg, false);
    int32_t barrierOffset = printPrefixAndMnemonicWithoutBarrier(log, instr, barrier);
...
void TR_Debug::print(TR::Logger *log, TR::X86MemRegInstruction *instr)
{
    int32_t barrier = memoryBarrierRequired(instr->getOpCode(), instr->getMemoryReference(), _cg, false);
    int32_t barrierOffset = printPrefixAndMnemonicWithoutBarrier(log, instr, barrier);
...
void TR_Debug::print(TR::Logger *log, TR::X86MemMaskRegInstruction *instr)
{
    int32_t barrier = memoryBarrierRequired(instr->getOpCode(), instr->getMemoryReference(), _cg, false);
    int32_t barrierOffset = printPrefixAndMnemonicWithoutBarrier(log, instr, barrier);
...
void TR_Debug::printReferencedRegisterInfo(TR::Logger *log, TR::X86MemRegInstruction *instr)
{
    printRegisterInfoHeader(log, instr);
    log->prints("    Source            ");
    printFullRegInfo(log, instr->getSourceRegister());
...
void TR_Debug::print(TR::Logger *log, TR::X86MemRegImmInstruction *instr)
{
    int32_t barrier = memoryBarrierRequired(instr->getOpCode(), instr->getMemoryReference(), _cg, false);
    int32_t barrierOffset = printPrefixAndMnemonicWithoutBarrier(log, instr, barrier);
...
void TR_Debug::print(TR::Logger *log, TR::X86RegMemInstruction *instr)
{
    int32_t barrier = memoryBarrierRequired(instr->getOpCode(), instr->getMemoryReference(), _cg, false);
    int32_t barrierOffset = printPrefixAndMnemonicWithoutBarrier(log, instr, barrier);
...
void TR_Debug::print(TR::Logger *log, TR::X86RegMaskMemInstruction *instr)
{
    int32_t barrier = memoryBarrierRequired(instr->getOpCode(), instr->getMemoryReference(), _cg, false);
    int32_t barrierOffset = printPrefixAndMnemonicWithoutBarrier(log, instr, barrier);
...
void TR_Debug::printReferencedRegisterInfo(TR::Logger *log, TR::X86RegMemInstruction *instr)
{
    printRegisterInfoHeader(log, instr);
    log->prints("    Target            ");
    printFullRegInfo(log, instr->getTargetRegister());
...
void TR_Debug::print(TR::Logger *log, TR::X86RegMemImmInstruction *instr)
{
    int32_t barrier = memoryBarrierRequired(instr->getOpCode(), instr->getMemoryReference(), _cg, false);
    int32_t barrierOffset = printPrefixAndMnemonicWithoutBarrier(log, instr, barrier);
...
void TR_Debug::print(TR::Logger *log, TR::X86RegRegMemInstruction *instr)
{
    int32_t barrier = memoryBarrierRequired(instr->getOpCode(), instr->getMemoryReference(), _cg, false);
    int32_t barrierOffset = printPrefixAndMnemonicWithoutBarrier(log, instr, barrier);
...
void TR_Debug::printReferencedRegisterInfo(TR::Logger *log, TR::X86RegRegMemInstruction *instr)
{
    printReferencedRegisterInfo(log, instr->getMemoryReference());
...
void TR_Debug::print(TR::Logger *log, TR::X86FPRegInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s\t", getMnemonicName(&instr->getOpCode()));
    if (!(instr->getOpCode().targetRegIsImplicit() != 0))
...
void TR_Debug::print(TR::Logger *log, TR::X86FPRegRegInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s\t", getMnemonicName(&instr->getOpCode()));
    if (!(instr->getOpCode().targetRegIsImplicit() != 0))
...
void TR_Debug::print(TR::Logger *log, TR::X86FPMemRegInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s\t", getMnemonicName(&instr->getOpCode()));
    print(log, instr->getMemoryReference(), getTargetSizeFromInstruction(instr));
...
void TR_Debug::print(TR::Logger *log, TR::X86FPRegMemInstruction *instr)
{
    int32_t barrier = memoryBarrierRequired(instr->getOpCode(), instr->getMemoryReference(), _cg, false);
    int32_t barrierOffset = printPrefixAndMnemonicWithoutBarrier(log, instr, barrier);
...
void TR_Debug::print(TR::Logger *log, TR::MemoryReference *mr, TR_RegisterSizes operandSize)
{
...
int32_t TR_Debug::printIntConstant(TR::Logger *log, int64_t value, int8_t radix, TR_RegisterSizes size,
    bool padWithZeros)
{
...
int32_t TR_Debug::printDecimalConstant(TR::Logger *log, int64_t value, int8_t width, bool padWithZeros)
{
    log->printf("%lld", value);
    return 0;
}

int32_t TR_Debug::printHexConstant(TR::Logger *log, int64_t value, int8_t width, bool padWithZeros)
{
...
void TR_Debug::printFPRegisterComment(TR::Logger *log, TR::Register *source, TR::Register *target)
{
    log->prints(" using ");
    if (target)
        print(log, target);
...
void TR_Debug::printInstructionComment(TR::Logger *log, int32_t tabStops, TR::Instruction *instr)
{
    while (tabStops-- > 0)
        log->printc('\t');
...
void TR_Debug::printMemoryReferenceComment(TR::Logger *log, TR::MemoryReference *mr)
{
...
void TR_Debug::printReferencedRegisterInfo(TR::Logger *log, TR::MemoryReference *mr)
{
    if (mr->getBaseRegister()) {
        log->prints("    Base Reg          ");
...
void TR_Debug::printX86GCRegisterMap(TR::Logger *log, TR::GCRegisterMap *map)
{
...
void TR_Debug::print(TR::Logger *log, TR::RealRegister *reg, TR_RegisterSizes size)
{
    switch (size) {
        case TR_WordReg:
        case TR_FloatReg:
...
void TR_Debug::printFullRegInfo(TR::Logger *log, TR::RealRegister *reg)
{
    log->prints("[ ");
...
void TR_Debug::printRegRegInstruction(TR::Logger *log, const char *opCode, TR::RealRegister *reg1,
...
void TR_Debug::printRegMemInstruction(TR::Logger *log, const char *opCode, TR::RealRegister *reg,
...
void TR_Debug::printRegImmInstruction(TR::Logger *log, const char *opCode, TR::RealRegister *reg, int32_t imm)
{
    log->printf("%s\t", opCode);
    print(log, reg);
    if (imm <= 1024)
...
void TR_Debug::printMemRegInstruction(TR::Logger *log, const char *opCode, TR::RealRegister *base, int32_t offset,
    TR::RealRegister *reg)
{
    log->printf("%s\t", opCode);
    log->printc('[');
...
void TR_Debug::printMemImmInstruction(TR::Logger *log, const char *opCode, TR::RealRegister *base, int32_t offset,
    int32_t imm)
{
    log->printf("%s\t", opCode);
    log->printc('[');
...
void TR_Debug::printLabelInstruction(TR::Logger *log, const char *opCode, TR::LabelSymbol *label)
{
    log->printf("%s\t", opCode);
    print(log, label);
}
...
#ifdef J9_PROJECT_SPECIFIC
void TR_Debug::print(TR::Logger *log, TR::X86CallSnippet *snippet)
{
...
#ifdef TR_TARGET_64BIT
uint8_t *TR_Debug::printArgumentFlush(TR::Logger *log, TR::Node *callNode,
