    ...
    , _minimumFirstInstructionSize(0)
{
    ...
    //
    OP::Mnemonic op
        = cg->getXMMDoubleLoadOpCode() ? cg->getXMMDoubleLoadOpCode() : OP::MOVSDRegMem;
...
OP::Mnemonic OMR::X86::Linkage::_movOpcodes[NumMovOperandTypes][NumMovDataTypes] = {
    ...
    {   OP::S4MemReg,   OP::S8MemReg, OP::MOVSSMemReg,
     OP::MOVSDMemReg }, // MemReg
    {   OP::L4RegMem,   OP::L8RegMem, OP::MOVSSRegMem,
     OP::MOVSDRegMem }, // RegMem
    { OP::MOV4RegReg, OP::MOV8RegReg, OP::MOVSSRegReg,
     OP::MOVSDRegReg }, // RegReg
};
