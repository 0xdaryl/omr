...
void TR_X86CompareAnalyser::integerCompareAnalyser(TR::Node *root, TR::Node *firstChild, TR::Node *secondChild,
    bool determineEvaluationOrder, OP::Mnemonic regRegOpCode, OP::Mnemonic regMemOpCode,
...
void TR_X86CompareAnalyser::integerCompareAnalyser(TR::Node *root, OP::Mnemonic regRegOpCode,
    OP::Mnemonic regMemOpCode, OP::Mnemonic memRegOpCode)
{
...
void TR_X86CompareAnalyser::longOrderedCompareAndBranchAnalyser(TR::Node *root,
    OP::Mnemonic lowBranchOpCode, OP::Mnemonic highBranchOpCode,
    OP::Mnemonic highReversedBranchOpCode)
{
    ...
    if (getCmpReg1Reg2()) {
        ...
        if (firstHighZero) {
            ...
            INST_RegReg(OP::CMP4RegReg, root, firstRegister->getHighOrder(),
    ...
    TR::LabelSymbol *secondBranchLabel, OP::Mnemonic secondBranchOp)
{
    ...
    if (getCmpReg1Reg2()) {
        INST_RegReg(OP::CMP4RegReg, root, firstRegister->getLowOrder(),
