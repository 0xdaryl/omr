...
enum OpCodeFlags : OpCodePropertiesWidth_t {
    ...
    opc_SupportsLOCKPrefix    = 0x08,
    opc_FusableCompare        = 0x10,
    opc_SetStatusFlagsForTEST = 0x20,
    opc_SetStatusFlagsForCMP  = 0x40,
};
...
enum OpCodeTupleType : OpCodePropertiesWidth_t {
    ...
    opc_Tuple8          = 6,
    opc_TupleHalfMem    = 7,
    opc_TupleQuarterMem = 8,
    opc_TupleEighthMem  = 9,
    opc_TupleMem128     = 10,
    opc_TupleMOVDDUP    = 11,
    opc_TupleFull       = 12, ///< Embedded Broadcast
    opc_TupleHalf       = 13, ///< Embedded Broadcast
};
...
struct OpCodeProperties {
    ...
    //
    OpCodePrefixes          opc_promoted2evex_pp : 2;
...
public:
    ...
    {
        return _opCodeTable[_mnemonic]._properties.opc_encPrefix & prefix;
    }

    inline const OpCodePropertiesWidth_t allowsAnyEncPrefix(OpCodePropertiesWidth_t prefixes)
    {
        return _opCodeTable[_mnemonic]._properties.opc_encPrefix & prefixes;
    }

    inline const OpCodePropertiesWidth_t allowsAllEncPrefixes(OpCodePropertiesWidth_t prefixes)
    {
        return (_opCodeTable[_mnemonic]._properties.opc_encPrefix & prefixes) == prefixes;
    }
