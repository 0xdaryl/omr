...
enum OpCodeTupleType : OpCodePropertiesWidth_t {
    ...
    opc_Tuple_8          = 6,
    opc_Tuple_HalfMem    = 7,
    opc_Tuple_QuarterMem = 8,
    opc_Tuple_EighthMem  = 9,
    opc_Tuple_Mem128     = 10,
    opc_Tuple_MOVDDUP    = 11,
    opc_Tuple_Full       = 12, ///< Embedded Broadcast
    opc_Tuple_Half       = 13, ///< Embedded Broadcast
};
...
struct OpCodeProperties {
    ...
    //
    OpCodeFlags             opc_flags : 3;

    OpCodeVectorLength      opc_LL : 2;
    OpCodeTupleType         opc_tupleType : 4;
