...
public:
    ...
    void integerCompareAnalyser(TR::Node *root, OP::Mnemonic regRegOpCode,
    ...
    TR::Register *longEqualityBooleanAnalyser(TR::Node *root, OP::Mnemonic setOpCode,
        OP::Mnemonic combineOpCode);

    TR::Register *longOrderedBooleanAnalyser(TR::Node *root, OP::Mnemonic highSetOpCode,
