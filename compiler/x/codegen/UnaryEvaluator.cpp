...
TR::Register *OMR::X86::TreeEvaluator::floatingPointAbsHelper(TR::Node *node, TR::CodeGenerator *cg)
{
    ...
    if (cmpEncoding >= EVEX_L128) {
        ...
        TR::InstOpCode ternOpcode = et == TR::Double ? OP::VPTERNLOGQRegMaskRegRegImm1
                                                     : OP::VPTERNLOGDRegMaskRegRegImm1;
        ...
        if (cg->comp()->target().cpu.supportsAVX()) {
            ...
            INST_RegRegImm(shrOpcode.getMnemonic(), node, resultReg, resultReg, 0x1, cg, shrEncoding);
            INST_RegRegReg(andOpcode.getMnemonic(), node, resultReg, resultReg, valueReg, cg,
                andEncoding);
        } else {
            INST_RegRegImm(cmpOpcode.getMnemonic(), node, resultReg, resultReg, 0x8, cg, cmpEncoding);
...
TR::Register *OMR::X86::TreeEvaluator::negEvaluatorHelper(TR::Node *node, OP::Mnemonic negInstr,
    TR::CodeGenerator *cg)
{
...
TR::Register *OMR::X86::TreeEvaluator::integerNegEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
    return TR::TreeEvaluator::negEvaluatorHelper(node,
        OP::NEGReg(TR::TreeEvaluator::getNodeIs64Bit(node, cg)), cg);
}
...
{
    return TR::TreeEvaluator::conversionAnalyser(node, OP::MOVZXReg4Mem1, OP::MOVZXReg4Reg1,
        cg);
}

TR::Register *OMR::X86::TreeEvaluator::b2sEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
    return TR::TreeEvaluator::conversionAnalyser(node, OP::MOVSXReg2Mem1, OP::MOVSXReg2Reg1,
        cg);
}

TR::Register *OMR::X86::TreeEvaluator::bu2sEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
    return TR::TreeEvaluator::conversionAnalyser(node, OP::MOVZXReg2Mem1, OP::MOVZXReg2Reg1,
        cg);
}

TR::Register *OMR::X86::TreeEvaluator::s2iEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
    return TR::TreeEvaluator::conversionAnalyser(node, OP::MOVSXReg4Mem2, OP::MOVSXReg4Reg2,
        cg);
}

TR::Register *OMR::X86::TreeEvaluator::su2iEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
    return TR::TreeEvaluator::conversionAnalyser(node, OP::MOVZXReg4Mem2, OP::MOVZXReg4Reg2,
        cg);
}
