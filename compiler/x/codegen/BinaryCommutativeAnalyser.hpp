...
public:
    ...
    void genericAnalyserWithExplicitOperands(TR::Node *root, TR::Node *firstChild, TR::Node *secondChild,
        OP::Mnemonic regRegOpCode, OP::Mnemonic regMemOpCode,
        OP::Mnemonic copyOpCode, bool nonClobberingDestination = false);

    void genericAnalyser(TR::Node *root, OP::Mnemonic regRegOpCode, OP::Mnemonic regMemOpCode,
        OP::Mnemonic copyOpCode, bool nonClobberingDestination = false);
    ...
    void genericLongAnalyser(TR::Node *root, OP::Mnemonic lowRegRegOpCode,
    ...
    void integerAddAnalyser(TR::Node *root, OP::Mnemonic regRegOpCode,
        OP::Mnemonic regMemOpCode, bool needsEflags = false,
    ...
    void integerAddAnalyserWithExplicitOperands(TR::Node *root, TR::Node *firstChild, TR::Node *secondChild,
        OP::Mnemonic regRegOpCode, OP::Mnemonic regMemOpCode, bool needsEflags = false,
        TR::Node *carry = 0);

    TR::Register *integerAddAnalyserImpl(TR::Node *root, TR::Node *firstChild, TR::Node *secondChild,
        OP::Mnemonic regRegOpCode, OP::Mnemonic regMemOpCode, bool needsEflags,
        TR::Node *carry);
