...
public:
   ...
   FunctionCallData(
      ...
      OMR::FunctionCallDataConnector(parm_methodSymRef, parm_callNode, parm_scratchReg, parm_targetAddress,
   ...
   FunctionCallData(
         ...
         TR::CodeGenerator *parm_cg,
         bool parm_isCall = true) :
      OMR::FunctionCallDataConnector(parm_methodSymRef, 0, parm_scratchReg, parm_targetAddress,
   ...
   FunctionCallData(
         ...
         TR::CodeGenerator *parm_cg,
         bool parm_isCall = true) :
      OMR::FunctionCallDataConnector(0, parm_callNode, 0, 0,
   ...
   FunctionCallData(
         ...
         TR::CodeGenerator *parm_cg,
         bool parm_isCall = true) :
      OMR::FunctionCallDataConnector(0, 0, 0, 0,
   ...
   FunctionCallData(
         ...
         TR::CodeGenerator *parm_cg,
         bool parm_isCall = true) :
      OMR::FunctionCallDataConnector(parm_methodSymRef, parm_callNode, 0, 0, 0,
