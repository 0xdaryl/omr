 ...
 */
    ...
    xmm0 = 19, FirstXMMR = xmm0, xmm1 = 20, xmm2 = 21, xmm3 = 22, xmm4 = 23, xmm5 = 24,
    xmm6 = 25, xmm7 = 26, xmm8 = 27, xmm9 = 28, xmm10 = 29, FirstSpillReg = xmm10, xmm11 = 30, xmm12 = 31, xmm13 = 32,
    xmm14 = 33, xmm15 = 34, LastSpillReg = xmm15, LastXMMR = xmm15,
    ...
    //
    st0 = xmm0, FirstFPR = st0, st1 = xmm1, st2 = xmm2, st3 = xmm3, st4 = xmm4,
    st5 = xmm5, st6 = xmm6, st7 = xmm7, LastAssignableFPR = st7,

    ymm0 = xmm0, FirstYMMR = ymm0, ymm1 = xmm1, ymm2 = xmm2, ymm3 = xmm3, ymm4 = xmm4,
    ...
    zmm0 = xmm0, FirstZMMR = zmm0, zmm1 = xmm1, zmm2 = xmm2, zmm3 = xmm3, zmm4 = xmm4,
