...
void
TR_Debug::print(TR::Logger *log, TR::PPCHelperCallSnippet *snippet)
   {
   ...
   log->printf("%s \t" POINTER_PRINTF_FORMAT "\t\t; %s %s",
...
uint8_t*
TR_Debug::print(TR::Logger *log, TR::PPCArrayCopyCallSnippet *snippet, uint8_t *cursor)
   {
