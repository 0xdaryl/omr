...
TR::RealRegister *OMR::Power::Machine::freeBestRegister(TR::Instruction     *currentInstruction,
      ...
      case TR_CCR:
         if (false /*!cg()->comp()->getOption(TR_DisableOOL) && (cg()->isOutOfLineColdPath() || cg()->isOutOfLineHotPath()) &&
            ...
            if (candidates[0]->getBackingStorage())
               ...
               {
               location = new (comp->trHeapMemory()) TR_PPCCRBackingStore(comp, self()->cg()->allocateSpill(4, false, NULL)); // TODO: Could this be 1 byte?
               }
            }
         break;
      case TR_VSX_VECTOR:
   ...
   tmemref = new (comp->trHeapMemory()) TR::MemoryReference(currentNode, location->getSymbolReference(), TR::Compiler->om.sizeofReferenceAddress(), self()->cg());
...
void OMR::Power::Machine::initializeRegisterFile()
   ...
   _registerFile[TR::RealRegister::gr0] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr0,
                                                 TR::RealRegister::gr0Mask, self()->cg());

   _registerFile[TR::RealRegister::gr1] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr1,
                                                 TR::RealRegister::gr1Mask, self()->cg());

   _registerFile[TR::RealRegister::gr2] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr2,
                                                 TR::RealRegister::gr2Mask, self()->cg());

   _registerFile[TR::RealRegister::gr3] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr3,
                                                 TR::RealRegister::gr3Mask, self()->cg());

   _registerFile[TR::RealRegister::gr4] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr4,
                                                 TR::RealRegister::gr4Mask, self()->cg());

   _registerFile[TR::RealRegister::gr5] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr5,
                                                 TR::RealRegister::gr5Mask, self()->cg());

   _registerFile[TR::RealRegister::gr6] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr6,
                                                 TR::RealRegister::gr6Mask, self()->cg());

   _registerFile[TR::RealRegister::gr7] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr7,
                                                 TR::RealRegister::gr7Mask, self()->cg());

   _registerFile[TR::RealRegister::gr8] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr8,
                                                 TR::RealRegister::gr8Mask, self()->cg());

   _registerFile[TR::RealRegister::gr9] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr9,
                                                 TR::RealRegister::gr9Mask, self()->cg());

   _registerFile[TR::RealRegister::gr10] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr10,
                                                 TR::RealRegister::gr10Mask, self()->cg());

   _registerFile[TR::RealRegister::gr11] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr11,
                                                 TR::RealRegister::gr11Mask, self()->cg());

   _registerFile[TR::RealRegister::gr12] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr12,
                                                 TR::RealRegister::gr12Mask, self()->cg());

   _registerFile[TR::RealRegister::gr13] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr13,
                                                 TR::RealRegister::gr13Mask, self()->cg());

   _registerFile[TR::RealRegister::gr14] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr14,
                                                 TR::RealRegister::gr14Mask, self()->cg());

   _registerFile[TR::RealRegister::gr15] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr15,
                                                 TR::RealRegister::gr15Mask, self()->cg());

   _registerFile[TR::RealRegister::gr16] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr16,
                                                 TR::RealRegister::gr16Mask, self()->cg());

   _registerFile[TR::RealRegister::gr17] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr17,
                                                 TR::RealRegister::gr17Mask, self()->cg());

   _registerFile[TR::RealRegister::gr18] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr18,
                                                 TR::RealRegister::gr18Mask, self()->cg());

   _registerFile[TR::RealRegister::gr19] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr19,
                                                 TR::RealRegister::gr19Mask, self()->cg());

   _registerFile[TR::RealRegister::gr20] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr20,
                                                 TR::RealRegister::gr20Mask, self()->cg());

   _registerFile[TR::RealRegister::gr21] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr21,
                                                 TR::RealRegister::gr21Mask, self()->cg());

   _registerFile[TR::RealRegister::gr22] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr22,
                                                 TR::RealRegister::gr22Mask, self()->cg());

   _registerFile[TR::RealRegister::gr23] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr23,
                                                 TR::RealRegister::gr23Mask, self()->cg());

   _registerFile[TR::RealRegister::gr24] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr24,
                                                 TR::RealRegister::gr24Mask, self()->cg());

   _registerFile[TR::RealRegister::gr25] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr25,
                                                 TR::RealRegister::gr25Mask, self()->cg());

   _registerFile[TR::RealRegister::gr26] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr26,
                                                 TR::RealRegister::gr26Mask, self()->cg());

   _registerFile[TR::RealRegister::gr27] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr27,
                                                 TR::RealRegister::gr27Mask, self()->cg());

   _registerFile[TR::RealRegister::gr28] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr28,
                                                 TR::RealRegister::gr28Mask, self()->cg());

   _registerFile[TR::RealRegister::gr29] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr29,
                                                 TR::RealRegister::gr29Mask, self()->cg());

   _registerFile[TR::RealRegister::gr30] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
                                                 TR::RealRegister::gr30,
                                                 TR::RealRegister::gr30Mask, self()->cg());

   _registerFile[TR::RealRegister::gr31] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
                                                 0,
                                                 TR::RealRegister::Free,
   ...
   _registerFile[TR::RealRegister::fp0] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp0, TR::RealRegister::fp0Mask, self()->cg());

   _registerFile[TR::RealRegister::fp1] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp1, TR::RealRegister::fp1Mask, self()->cg());

   _registerFile[TR::RealRegister::fp2] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp2, TR::RealRegister::fp2Mask, self()->cg());

   _registerFile[TR::RealRegister::fp3] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp3, TR::RealRegister::fp3Mask, self()->cg());

   _registerFile[TR::RealRegister::fp4] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp4, TR::RealRegister::fp4Mask, self()->cg());

   _registerFile[TR::RealRegister::fp5] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp5, TR::RealRegister::fp5Mask, self()->cg());

   _registerFile[TR::RealRegister::fp6] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp6, TR::RealRegister::fp6Mask, self()->cg());

   _registerFile[TR::RealRegister::fp7] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp7, TR::RealRegister::fp7Mask, self()->cg());

   _registerFile[TR::RealRegister::fp8] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp8, TR::RealRegister::fp8Mask, self()->cg());

   _registerFile[TR::RealRegister::fp9] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp9, TR::RealRegister::fp9Mask, self()->cg());

   _registerFile[TR::RealRegister::fp10] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp10, TR::RealRegister::fp10Mask, self()->cg());

   _registerFile[TR::RealRegister::fp11] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp11, TR::RealRegister::fp11Mask, self()->cg());

   _registerFile[TR::RealRegister::fp12] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp12, TR::RealRegister::fp12Mask, self()->cg());

   _registerFile[TR::RealRegister::fp13] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp13, TR::RealRegister::fp13Mask, self()->cg());

   _registerFile[TR::RealRegister::fp14] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp14, TR::RealRegister::fp14Mask, self()->cg());

   _registerFile[TR::RealRegister::fp15] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp15, TR::RealRegister::fp15Mask, self()->cg());

   _registerFile[TR::RealRegister::fp16] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp16, TR::RealRegister::fp16Mask, self()->cg());

   _registerFile[TR::RealRegister::fp17] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp17, TR::RealRegister::fp17Mask, self()->cg());

   _registerFile[TR::RealRegister::fp18] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp18, TR::RealRegister::fp18Mask, self()->cg());

   _registerFile[TR::RealRegister::fp19] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp19, TR::RealRegister::fp19Mask, self()->cg());

   _registerFile[TR::RealRegister::fp20] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp20, TR::RealRegister::fp20Mask, self()->cg());

   _registerFile[TR::RealRegister::fp21] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp21, TR::RealRegister::fp21Mask, self()->cg());

   _registerFile[TR::RealRegister::fp22] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp22, TR::RealRegister::fp22Mask, self()->cg());

   _registerFile[TR::RealRegister::fp23] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp23, TR::RealRegister::fp23Mask, self()->cg());

   _registerFile[TR::RealRegister::fp24] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp24, TR::RealRegister::fp24Mask, self()->cg());

   _registerFile[TR::RealRegister::fp25] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp25, TR::RealRegister::fp25Mask, self()->cg());

   _registerFile[TR::RealRegister::fp26] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp26, TR::RealRegister::fp26Mask, self()->cg());

   _registerFile[TR::RealRegister::fp27] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp27, TR::RealRegister::fp27Mask, self()->cg());

   _registerFile[TR::RealRegister::fp28] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp28, TR::RealRegister::fp28Mask, self()->cg());

   _registerFile[TR::RealRegister::fp29] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp29, TR::RealRegister::fp29Mask, self()->cg());

   _registerFile[TR::RealRegister::fp30] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp30, TR::RealRegister::fp30Mask, self()->cg());

   _registerFile[TR::RealRegister::fp31] = new (comp->trHeapMemory()) TR::RealRegister(TR_FPR,
               0, TR::RealRegister::Free, TR::RealRegister::fp31, TR::RealRegister::fp31Mask, self()->cg());

   _registerFile[TR::RealRegister::cr0] = new (comp->trHeapMemory()) TR::RealRegister(TR_CCR,
               0, TR::RealRegister::Free, TR::RealRegister::cr0, TR::RealRegister::cr0Mask, self()->cg());

   _registerFile[TR::RealRegister::cr1] = new (comp->trHeapMemory()) TR::RealRegister(TR_CCR,
               0, TR::RealRegister::Free, TR::RealRegister::cr1, TR::RealRegister::cr1Mask, self()->cg());

   _registerFile[TR::RealRegister::cr2] = new (comp->trHeapMemory()) TR::RealRegister(TR_CCR,
               0, TR::RealRegister::Free, TR::RealRegister::cr2, TR::RealRegister::cr2Mask, self()->cg());

   _registerFile[TR::RealRegister::cr3] = new (comp->trHeapMemory()) TR::RealRegister(TR_CCR,
               0, TR::RealRegister::Free, TR::RealRegister::cr3, TR::RealRegister::cr3Mask, self()->cg());

   _registerFile[TR::RealRegister::cr4] = new (comp->trHeapMemory()) TR::RealRegister(TR_CCR,
               0, TR::RealRegister::Free, TR::RealRegister::cr4, TR::RealRegister::cr4Mask, self()->cg());

   _registerFile[TR::RealRegister::cr5] = new (comp->trHeapMemory()) TR::RealRegister(TR_CCR,
               0, TR::RealRegister::Free, TR::RealRegister::cr5, TR::RealRegister::cr5Mask, self()->cg());

   _registerFile[TR::RealRegister::cr6] = new (comp->trHeapMemory()) TR::RealRegister(TR_CCR,
               0, TR::RealRegister::Free, TR::RealRegister::cr6, TR::RealRegister::cr6Mask, self()->cg());

   _registerFile[TR::RealRegister::cr7] = new (comp->trHeapMemory()) TR::RealRegister(TR_CCR,
               0, TR::RealRegister::Free, TR::RealRegister::cr7, TR::RealRegister::cr7Mask, self()->cg());

   _registerFile[TR::RealRegister::lr] = new (comp->trHeapMemory()) TR::RealRegister(TR_GPR,
               0, TR::RealRegister::Free, TR::RealRegister::lr, TR::RealRegister::noRegMask, self()->cg());

   _registerFile[TR::RealRegister::vr0] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr0, TR::RealRegister::vr0Mask, self()->cg());

   _registerFile[TR::RealRegister::vr1] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr1, TR::RealRegister::vr1Mask, self()->cg());

   _registerFile[TR::RealRegister::vr2] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr2, TR::RealRegister::vr2Mask, self()->cg());

   _registerFile[TR::RealRegister::vr3] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr3, TR::RealRegister::vr3Mask, self()->cg());

   _registerFile[TR::RealRegister::vr4] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr4, TR::RealRegister::vr4Mask, self()->cg());

   _registerFile[TR::RealRegister::vr5] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr5, TR::RealRegister::vr5Mask, self()->cg());

   _registerFile[TR::RealRegister::vr6] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr6, TR::RealRegister::vr6Mask, self()->cg());

   _registerFile[TR::RealRegister::vr7] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr7, TR::RealRegister::vr7Mask, self()->cg());

   _registerFile[TR::RealRegister::vr8] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr8, TR::RealRegister::vr8Mask, self()->cg());

   _registerFile[TR::RealRegister::vr9] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr9, TR::RealRegister::vr9Mask, self()->cg());

   _registerFile[TR::RealRegister::vr10] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr10, TR::RealRegister::vr10Mask, self()->cg());

   _registerFile[TR::RealRegister::vr11] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr11, TR::RealRegister::vr11Mask, self()->cg());

   _registerFile[TR::RealRegister::vr12] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr12, TR::RealRegister::vr12Mask, self()->cg());

   _registerFile[TR::RealRegister::vr13] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr13, TR::RealRegister::vr13Mask, self()->cg());

   _registerFile[TR::RealRegister::vr14] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr14, TR::RealRegister::vr14Mask, self()->cg());

   _registerFile[TR::RealRegister::vr15] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr15, TR::RealRegister::vr15Mask, self()->cg());

   _registerFile[TR::RealRegister::vr16] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr16, TR::RealRegister::vr16Mask, self()->cg());

   _registerFile[TR::RealRegister::vr17] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr17, TR::RealRegister::vr17Mask, self()->cg());

   _registerFile[TR::RealRegister::vr18] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr18, TR::RealRegister::vr18Mask, self()->cg());

   _registerFile[TR::RealRegister::vr19] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr19, TR::RealRegister::vr19Mask, self()->cg());

   _registerFile[TR::RealRegister::vr20] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr20, TR::RealRegister::vr20Mask, self()->cg());

   _registerFile[TR::RealRegister::vr21] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr21, TR::RealRegister::vr21Mask, self()->cg());

   _registerFile[TR::RealRegister::vr22] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr22, TR::RealRegister::vr22Mask, self()->cg());

   _registerFile[TR::RealRegister::vr23] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr23, TR::RealRegister::vr23Mask, self()->cg());

   _registerFile[TR::RealRegister::vr24] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr24, TR::RealRegister::vr24Mask, self()->cg());

   _registerFile[TR::RealRegister::vr25] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr25, TR::RealRegister::vr25Mask, self()->cg());

   _registerFile[TR::RealRegister::vr26] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr26, TR::RealRegister::vr26Mask, self()->cg());

   _registerFile[TR::RealRegister::vr27] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr27, TR::RealRegister::vr27Mask, self()->cg());

   _registerFile[TR::RealRegister::vr28] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr28, TR::RealRegister::vr28Mask, self()->cg());

   _registerFile[TR::RealRegister::vr29] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr29, TR::RealRegister::vr29Mask, self()->cg());

   _registerFile[TR::RealRegister::vr30] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
               0, TR::RealRegister::Free, TR::RealRegister::vr30, TR::RealRegister::vr30Mask, self()->cg());

   _registerFile[TR::RealRegister::vr31] = new (comp->trHeapMemory()) TR::RealRegister(TR_VRF,
