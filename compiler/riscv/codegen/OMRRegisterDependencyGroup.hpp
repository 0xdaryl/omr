...
#ifndef OMR_RV_REGISTER_DEPENDENCY_GROUP_INCL
#define OMR_RV_REGISTER_DEPENDENCY_GROUP_INCL
...
namespace OMR { namespace RV { class RegisterDependencyGroup; } }
namespace OMR { typedef OMR::RV::RegisterDependencyGroup RegisterDependencyGroupConnector; }
#else
#error OMR::RV::RegisterDependencyGroup expected to be a primary connector, but an OMR connector is already defined
#endif
