...
void
TR_Debug::print(TR::Logger *log, TR::DataInstruction *instr)
   {
   printPrefix(log, instr);
   log->printf("%s \t0x%08x (%d)", getOpCodeName(&instr->getOpCode()), instr->getSourceImmediate(), instr->getSourceImmediate());
   log->flush();
   }

void
TR_Debug::print(TR::Logger *log, TR::RtypeInstruction *instr)
   {
   printPrefix(log, instr);
...
void
TR_Debug::print(TR::Logger *log, TR::ItypeInstruction *instr)
   {
   printPrefix(log, instr);
   log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
   print(log, instr->getTargetRegister(), TR_WordReg);
...
void
TR_Debug::print(TR::Logger *log, TR::StypeInstruction *instr)
   {
   printPrefix(log, instr);
   log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
   print(log, instr->getSource1Register(), TR_WordReg);
...
TR_Debug::print(TR::Logger *log, TR::BtypeInstruction *instr)
   {
   printPrefix(log, instr);
   log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
   print(log, instr->getSource1Register(), TR_WordReg);
...
TR_Debug::print(TR::Logger *log, TR::UtypeInstruction *instr)
   {
   printPrefix(log, instr);
   log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
   print(log, instr->getTargetRegister(), TR_WordReg);
...
TR_Debug::print(TR::Logger *log, TR::JtypeInstruction *instr)
   {
   printPrefix(log, instr);
   log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
   print(log, instr->getTargetRegister(), TR_WordReg);
...
void
TR_Debug::print(TR::Logger *log, TR::LoadInstruction *instr)
   {
   printPrefix(log, instr);
   log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
   print(log, instr->getTargetRegister(), TR_WordReg);
...
void
TR_Debug::print(TR::Logger *log, TR::StoreInstruction *instr)
   {
   printPrefix(log, instr);
   log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
   print(log, instr->getSource1Register(), TR_WordReg);
...
void
TR_Debug::print(TR::Logger *log, TR::LabelInstruction *instr)
   {
   printPrefix(log, instr);
...
void
TR_Debug::print(TR::Logger *log, TR::AdminInstruction *instr)
   {
   printPrefix(log, instr);
   log->printf("%s ", getOpCodeName(&instr->getOpCode()));
...
/*
void
TR_Debug::print(TR::Logger *log, TR::RVTrg1Instruction *instr)
   {
   printPrefix(log, instr);
   log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
   print(log, instr->getTargetRegister(), TR_WordReg);
...
void
TR_Debug::printRVGCRegisterMap(TR::Logger *log, TR::GCRegisterMap *map)
   {
   TR_UNIMPLEMENTED();
   }
...
void TR_Debug::printRVOOLSequences(TR::Logger *log)
   {
   TR_UNIMPLEMENTED();
   }
